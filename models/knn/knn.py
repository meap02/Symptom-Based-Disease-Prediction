    ...
    for weights in ['uniform', 'distance']:
        for algo in ['auto']:#, 'ball_tree', 'kd_tree', 'brute']:
            ...
            if s_score > s_best_accuracy:
                ...
                s_best_algo = algo
                s_best_model = single
                print("New best single accuracy: {accuracy} with {n} neighbors, {weights} weights and {algo} algo".format(accuracy=s_best_accuracy, n=s_best_n, weights=weights, algo=algo))
            ...
            if e_score > e_best_accuracy:
                ...
                print("New best ensemble accuracy: {accuracy} with {n} neighbors, {weights} weights and {algo} algo".format(accuracy=e_best_accuracy, n=e_best_n, weights=weights, algo=algo))
'''
